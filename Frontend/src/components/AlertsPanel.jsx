...
/**
 * AlertsPanel (modern ops panel)
 * Props:
 * - onSelectAlert?: (alert) => void     // click card / view details
 * - onLocateAlert?: (alert) => void     // click Locate button (center map)
 * - enableSimulation?: boolean          // demo: adds new alerts periodically
 * - className?: string
 */
...
export default function AlertsPanel({
  ...
  return (
    ...
    >
      ...
      {/* Filters (severity tabs + status dropdown) */}
      <div className="px-3 pt-3">
        <div className="flex items-center gap-2">
                    ...
                    <div className="rounded-xl border border-white/10 bg-white/5 p-3">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="mt-1 text-[11px] font-semibold text-white/85">
                            Assign this alert to an operator
                          </div>
                        </div>
