...
CREATE TYPE anomaly_type_enum AS ENUM ('speed', 'route', 'behavoir');

CREATE TABLE anomalies (
  anomaly_id BIGSERIAL PRIMARY KEY,
  mmsi INTEGER NOT NULL REFERENCES ships(mmsi) ON DELETE CASCADE,
  anomaly_type anomaly_type_enum NOT NULL,
  sog NUMERIC(6,2) NULL,
  cog NUMERIC(6,2) NULL,
  heading SMALLINT NULL,
  nav_status SMALLINT NULL,
  p99_speed NUMERIC(6,2) NULL,
  details JSONB NULL,
  lon DOUBLE PRECISION NULL,
  alt DOUBLE PRECISION NULL,
  detected_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
);
CREATE INDEX idx_anomalies_vessel_time ON anomalies(mmsi, detected_at);
