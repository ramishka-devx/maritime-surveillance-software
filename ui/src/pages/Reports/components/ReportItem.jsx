...
export function ReportItem({ report, onDownload }) {
  ...
  return (
    <div className="flex items-center justify-between gap-4 rounded-xl border border-gray-200 border-l-4 border-l-[#0b74c9] bg-white p-3 hover:bg-slate-50 transition shadow-sm">
      ...
      <button
        ...
        className={[
          "inline-flex items-center rounded-xl px-4 py-2 text-sm font-extrabold transition",
          canDownload
